...
class Explore extends React.Component {
  ...
  displayContent = () => {
    ...
    // if (!createEventMode && panelPosition < 120) {
    ...
    if (createEventMode) {
      ...
      return (
        <_.RelevantEvents
          ...
          allowDragging={allowDragging => this.setState({allowDragging})}
        />
      );
    }
  };
    ...
    return (
      <SafeArea style={styles.container}>
        ...
        <SlidingUpPanel
          ...
          draggableRange={{top: height / 1.5, bottom: 90}}
          onDragEnd={position => this.setState({panelPosition: position})}
          gestureState={e => console.log(e)}>
