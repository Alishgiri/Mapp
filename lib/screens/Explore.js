...
class Explore extends React.Component {
  ...
  render() {
    const {createEventMode} = this.state;
      ...
      <SafeArea style={styles.container}>
        ...
        <SlidingUpPanel
          ...
          <View style={styles.slideup_container}>
            {createEventMode ? (
              <_.CreateEvent onClose={this.toggleCreateEventMode} />
            ) : (
              <_.RelevantEvents onCreateEvent={this.toggleCreateEventMode} />
            )}
          </View>
          <AppButton
