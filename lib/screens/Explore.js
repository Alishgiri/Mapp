...
import {ORANGE, OFFWHITE, PURPLE} from '../utilities/constants/style-constants';
...
class Explore extends React.Component {
  ...
  componentDidMount() {
    // this.trackerOne = false;
    // this.trackerTwo = false;
  ...
  onAnimatedValueChange = ({value}) => {
    ...
    // if (value >= half_screen && !this.trackerOne) {
    //   this.trackerOne = true;
    //   this.animateEvents();
    // }
    // if (value < half_screen && !this.trackerTwo) {
    //   this.trackerTwo = true;
    //   this.animateExpore();
    // }
  };
  ...
  render() {
    ...
    const draggableRange = height / 1.5; //createEventMode ? height / 1.7 : height / 1.5;
    const animation = {
    ...
    return (
      <KeyboardAvoidingView style={{flex: 1}} behavior="height">
        ...
        <SlidingUpPanel
          ...
          containerStyle={{paddingTop: 30, elevation: 5}}
